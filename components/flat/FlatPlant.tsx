...
export const FlatPlant = ({item, index,}: { item: Plant, index: number }) => {
    ...
    return (
        <View style={{backgroundColor: "rgb(230,255,230)", marginTop: 10, borderRadius: 20}}>
            <Pressable
                style={{
                    width: '100%',
                    display: "flex",
            ...
            >
                <Image
                    ...
                    source={{uri: item.img}}
                    style={{width: '25%', height: 100, borderRadius: 35, margin: 10}}
                />
                <View style={{margin: 10, display: "flex",justifyContent:"center",gap:5}}>
